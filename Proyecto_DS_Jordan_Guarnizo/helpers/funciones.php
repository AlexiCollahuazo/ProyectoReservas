<?php
//-------------------------------------------------------------------------
// Limpia caracteres especiales - para prevenir inyección sql
...
//-------------------------------------------------------------------------
//Crear slug -- cadena de caracteres amigable para las urls
function slugify($text, string $divider = '-'){

  //reemplazar caracteres no alfabéticos o dígitos por el divisor
