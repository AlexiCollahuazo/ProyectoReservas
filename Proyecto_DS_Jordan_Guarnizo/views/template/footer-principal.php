                ...
                <div class="col-lg-12 col-md-12">
                    <div class="single-widget">
                        <a href="<?php echo RUTA_PRINCIPAL; ?>">
                            <img src="<?php echo RUTA_PRINCIPAL . 'assets'; ?>/img/logo.png" width="70" height=auto alt="Image">
                        </a>
                        <p><?= $data['empresa']['mensaje']; ?></p>
                        <ul class="social-icon">
                            <li>
                                <a href="<?php echo $data['empresa']['facebook']; ?>" target="_blank">
                                    <i class="bx bxl-facebook"></i>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo $data['empresa']['twitter']; ?>" target="_blank">
                                    <i class="bx bxl-twitter"></i>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo $data['empresa']['whatsapp']; ?>" target="_blank">
                                    <i class="bx bxl-whatsapp"></i>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo $data['empresa']['instagram']; ?>" target="_blank">
